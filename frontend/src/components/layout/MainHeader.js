...
const NavLink = ({ to, children, icon }) => (
  <Link
    to={to}
    className="flex items-center px-3 py-2 text-black   hover:bg-primary-light/20 rounded-md transition-colors duration-150"
  >
    ...
    <header className="bg-gray-900/80 backdrop-blur-md shadow-lg fixed top-0 left-0 right-0 z-50 border-b border-gray-700/50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          {/* Desktop Navigation */}
          <nav className="hidden md:flex space-x-2 text-black ">
