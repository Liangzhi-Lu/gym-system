...
const mockSchedules = [
  ...
  },
  {
    ...
    course_instructor: 'Bob',
  },
  {
    id: 103,
    start_time: '2024-07-05T09:00:00',
    end_time: '2024-07-05T09:30:00',
    location: 'Room C',
    current_capacity: 5,
    capacity: 25,
    course: 3,
    course_name: 'Flexibility Flow',
    course_instructor: 'Carol',
  },
  {
    id: 104,
    start_time: '2024-07-06T16:00:00',
    end_time: '2024-07-06T16:50:00',
    location: 'Room D',
    current_capacity: 7,
    capacity: 10,
    course: 4,
    course_name: 'Combat Fitness',
    course_instructor: 'David',
  },
];
...
const ScheduleCard = ({ schedule }) => {
  ...
  return (
    <div className="text-black backdrop-blur-sm rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-700/50 group flex flex-col h-full transform hover:-translate-y-1">
      <div className="p-5 flex flex-col h-full">
        ...
        <div className="flex items-center mb-4">
          ...
          <span className="text-black">{formatTimeRange(schedule.start_time, schedule.end_time)}</span>
        </div>
        ...
        <div className="flex-grow">
          <h3 className="text-lg font-bold text-black leading-tight mb-2">{schedule.course_name}</h3>
...
const SchedulesPage = () => {
    ...
    return (
      <div className="container mx-auto px-4 py-16 flex justify-center">
        <div className="text-center">
          ...
          <h3 className="text-2xl font-semibold text-black">Loading course schedules...</h3>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-2xl md:text-3xl font-bold text-black mb-2">Course Schedule</h1>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-8">
        ...
        <div className="relative flex-grow md:max-w-md">
          ...
          <input
            type="text"
            className="block w-full pl-10 pr-3 py-2 border border-gray-700 rounded-lg  text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary"
