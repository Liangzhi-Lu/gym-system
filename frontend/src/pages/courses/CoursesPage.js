...
const mockCourses = [
  ...
  },
  {
    ...
    description: 'Build muscle and strength with guided sessions.',
  ...
  },
  {
    ...
    category: { id: 'flexibility', name: 'Flexibility' },
    instructor: { username: 'Carol' },
    duration: 30,
  ...
  },
  {
    id: 4,
    name: 'Combat Fitness',
    description: 'Fun combat-inspired fitness class.',
    image: '',
    category: { id: 'combat', name: 'Combat' },
    instructor: { username: 'David' },
    duration: 50,
    difficulty: 'advanced',
    price: 150,
    rating: 4.9,
  ...
  <div className=" backdrop-blur-sm rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-700/50 group h-full flex flex-col transform hover:-translate-y-1">
    ...
    <div className="p-5 flex flex-col flex-grow">
      <div className="flex justify-between items-start mb-2">
        <h3 className="text-lg font-bold text-black leading-tight">{course.name}</h3>
      ...
      <p className="text-black text-sm mb-4 flex-grow">{course.description}</p>
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-12">
        <h1 className="text-3xl md:text-4xl font-bold text-black mb-4">Explore Our Courses</h1>
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-between items-start md:items-center mb-4">
          <div className="relative w-full md:w-96">
            <input
              ...
              className="w-full  border border-gray-700 rounded-xl py-3 pl-12 pr-4 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
            />
