...
const mockCourse = {
  id: 1,
  name: 'Cardio Blast',
  description: 'High-intensity aerobic workout to burn calories.',
  image: '',
  ...
  rating_count: 12,
  capacity: 20,
  category: { id: 'cardio', name: 'Aerobic' },
};
...
const mockSchedules = [
  ...
  {
    id: 102,
    start_time: '2024-07-03T14:00:00',
    end_time: '2024-07-03T14:45:00',
    location: 'Room B',
    current_capacity: 20,
    capacity: 20,
  },
...
const CourseDetailPage = () => {
  ...
  const handleEnroll = async (scheduleId) => {
    ...
    try {
      ...
      if (errorMsg === 'You have already enrolled in this course') {
        errorMsg = 'You have already enrolled in this course';
      } else if (errorMsg === 'This course is full, cannot enroll') {
        errorMsg = 'This course is full, cannot enroll';
      } else if (errorMsg === 'This field is required.') {
        errorMsg = 'This field is required.';
      } else if (errorMsg === 'Only members can enroll in courses') {
        errorMsg = 'Only members can enroll in courses';
      } else if (errorMsg === 'Your membership has expired, please renew') {
        errorMsg = 'Your membership has expired, please renew';
      } else if (errorMsg === 'Your user role does not allow course enrollment') {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Breadcrumb */}
      <div className="mb-6 flex items-center text-gray-800 text-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
        <div className="lg:col-span-2">
          <h1 className="text-3xl md:text-4xl font-bold text-black mb-4">{course.name}</h1>
          
          <div className="flex flex-wrap items-center text-black mb-6 gap-4">
            {course.instructor_name && (
              <div className="flex items-center">
                <Users className="h-5 w-5 mr-2 text-primary" />
                <span>Instructor: <span className="text-black">{course.instructor_name}</span></span>
              </div>
            )}
            ...
            {course.difficulty && (
              <div className="flex items-center">
                ...
                <span>Difficulty: <span className="text-black">{
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          ...
          {/* Course description */}
          <div className="mb-6  backdrop-blur-sm rounded-xl p-6 border border-gray-700/50">
            <h2 className="text-xl font-bold text-black mb-4">Course Description</h2>
            <div className="prose prose-invert max-w-none">
              <p className="text-black whitespace-pre-line">{course.description}</p>
            </div>
          </div>

          {/* Schedule */}
          <div className="backdrop-blur-sm rounded-xl p-6 mb-8 border border-gray-700/50">
            <h2 className="text-xl font-bold mb-4 text-black">Course Schedule</h2>
              ...
              <div className="space-y-4">
                {schedules.map((schedule) => {
                  ...
                  return (
                    <div 
                      key={schedule.id} 
                      className="flex flex-col md:flex-row justify-between items-start md:items-center p-4 rounded-lg  border border-gray-600/50"
                    >
          ...
          {/* Instructor */}
          <div className=" backdrop-blur-sm rounded-xl p-6 border border-gray-700/50">
            <h2 className="text-xl font-bold mb-4 text-black">About the Instructor</h2>
            
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 text-black">
        ...
        <div>
          {/* Course Info Card */}
          <div className=" backdrop-blur-sm rounded-xl p-6 border border-gray-700/50 sticky top-6">
            <div className="text-3xl font-bold text-black mb-6">${course.price}</div>
            
            <div className="space-y-4 mb-6">
              <div className="flex justify-between items-center">
                <div className="text-gray-400">Duration</div>
                <div className="text-black font-medium">{course.duration} minutes</div>
              </div>
              
              <div className="flex justify-between items-center">
                <div className="text-gray-400">Capacity</div>
                <div className="text-black font-medium">{course.capacity} per class</div>
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="text-black font-medium">{course.category?.name || 'Uncategorized'}</div>
              </div>
            </div>
