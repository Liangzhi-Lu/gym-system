...
const CourseCard = ({ course }) => (
  <div className=" backdrop-blur-sm rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-700/50 group h-full flex flex-col transform hover:-translate-y-1">
    ...
    <div className="p-5 flex flex-col flex-grow">
      <div className="flex justify-between items-start mb-2">
        <h3 className="text-lg font-bold text-black leading-tight">{course.title}</h3>
      ...
      <p className="text-gray-800 text-sm mb-4 flex-grow">{course.description}</p>
...
const MembershipCard = ({ plan }) => (
  <div className={`rounded-xl overflow-hidden shadow-lg transition-all duration-300 border border-gray-700/50 flex flex-col transform hover:-translate-y-2 ${plan.recommended ? 'ring-2 ring-secondary relative z-10 scale-105' : ''}`}>
    ...
    <div className="p-6  backdrop-blur-sm flex-grow flex flex-col">
...
const HomePage = () => {
  ...
  return (
    <div>
      ...
      <section className="relative h-[600px] md:h-[700px] overflow-hidden border-2 border-gray-500/70 rounded-xl shadow-lg">
        {/* Background Slides */}
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-3xl transition-all duration-700 transform translate-y-0 opacity-100">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link 
                  to="/membership"
                  className="bg-transparent text-black font-bold py-3 px-8 rounded-lg border border-black hover:bg-white/10 transition-all duration-200"
                >
                  View Plans
                </Link>
              </div>
        ...
        {/* Navigation Arrows */}
        <button 
          className="z-10 absolute left-4 top-1/2 transform -translate-y-1/2 bg-black/30 backdrop-blur-sm text-white rounded-full p-2 hover:bg-primary transition-colors duration-200"
          onClick={prevSlide}
        >
          <ChevronLeft className="w-6 h-6" />
        </button>
        <button 
          className="z-10 absolute right-4 top-1/2 transform -translate-y-1/2 bg-black/30 backdrop-blur-sm text-white rounded-full p-2 hover:bg-primary transition-colors duration-200"
          onClick={nextSlide}
        >
      ...
      <section className="py-20 bg-gray-900">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-black mb-4">Why Choose <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">GymSys</span></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className=" backdrop-blur-sm rounded-xl p-8 border border-gray-700/50 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-primary/5">
              <div className="w-14 h-14 bg-primary/20 rounded-lg flex items-center justify-center mb-6">
                <Dumbbell className="w-8 h-8 text-primary" />
              </div>
              <h3 className="text-xl font-bold text-black mb-3">Advanced Equipment</h3>
              <p className="text-gray-600">State-of-the-art fitness equipment designed for optimal performance and results.</p>
            </div>
            ...
            <div className=" backdrop-blur-sm rounded-xl p-8 border border-gray-700/50 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-primary/5">
              ...
              <h3 className="text-xl font-bold text-black mb-3">Expert Trainers</h3>
              <p className="text-gray-600">Certified professionals dedicated to helping you achieve your fitness goals safely and effectively.</p>
            </div>
            ...
            <div className="backdrop-blur-sm rounded-xl p-8 border border-gray-700/50 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-primary/5">
              ...
              <p className="text-gray-600">Book classes and sessions at your convenience with our easy-to-use digital platform.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 ">
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap items-center justify-between mb-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-black mb-2">Featured Courses</h2>
              <p className="text-gray-600">Discover our most popular training programs</p>
            </div>
      ...
      <section className="py-20 bg-gray-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-black mb-4">Membership Plans</h2>
