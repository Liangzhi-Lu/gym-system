...
const ProfilePage = () => {
  ...
  useEffect(() => {
    ...
    setProfileData({ ...mockUser.profile });
  }, []);
    ...
    if (currentUser) {
      ...
      if (mockUser.profile) {
        setProfileData({
          ...
          fitness_goal: mockUser.profile.fitness_goal || '',
          fitness_level: mockUser.profile.fitness_level || '',
          health_condition: mockUser.profile.health_condition || '',
        });
      } else {
        // If nested profile data isn't included in the user object, fetch it
        const fetchProfileData = async () => {
          try {
            const response = await axios.get(`/api/users/${mockUser.id}/profile/`);
            setProfileData({
  ...
  //
  //   try {
  //     const response = await axios.post(`/api/users/${mockUser.id}/avatar/`, formData, {
  //       headers: {
  ...
  const handleAvatarUpload = async () => {
    setIsUploading(true);
    setTimeout(() => {
      setAvatarPreview('/images/default-avatar.jpg'); // 直接用本地预览
      setIsUploading(false);
      setAvatarFile(null);
      // showToast('Avatar updated successfully!', 'success');
    }, 500);
  ...
  //       <p className="mt-4 text-lg text-black ">Loading profile...</p>
  //     </div>
  //   );
  // }
    ...
    <div className="py-8">
      <div className="max-w-5xl mx-auto">
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-800 mt-2">Manage your account and personal information</p>
        </div>
        
        {/* Profile Card */}
        <div className="backdrop-blur-sm rounded-2xl shadow-xl border border-gray-700/50 overflow-hidden mb-8">
          {/* Profile Header */}
          <div className="bg-gradient-to-r  p-6 sm:p-8 flex flex-col sm:flex-row gap-6 items-center border-b border-gray-700/50">
            {/* Avatar */}
              ...
              {avatarFile && editMode && (
                <div className="mt-2 flex justify-center">
                  <button
                    ...
                    className="flex items-center text-xs bg-primary text-black px-3 py-1 rounded-full"
                  >
                    {isUploading ? (
                      <>
            ...
            <div className="text-center sm:text-left flex-grow">
              ...
              <p className="text-gray-800 mt-1">{mockUser.email}</p>
              
              <div className="mt-3 flex flex-wrap gap-2 justify-center sm:justify-start">
                <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-primary/20 text-primary">
                  {mockUser.role || 'Member'}
                </span>
                {mockUser.membership_type && (
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-secondary/20 text-secondary">
                    {mockUser.membership_type === 'monthly' ? 'Monthly' :
                     mockUser.membership_type === 'quarterly' ? 'Quarterly' :
                     mockUser.membership_type === 'yearly' ? 'Yearly' : 'Premium'} Membership
                  </span>
                )}
              </div>
            </div>
              ...
              {editMode ? (
                <div className="flex gap-2">
                  <button
                    ...
                    className="p-2 text-gray-400 hover:text-black bg-gray-700 hover:bg-gray-600 rounded-lg"
                  >
                    <X className="w-5 h-5" />
                  </button>
                  <button
                    ...
                    disabled={isSaving}
                    className="p-2 text-black bg-primary hover:bg-primary-dark rounded-lg flex items-center"
                  >
                    {isSaving ? (
                ...
                <button
                  ...
                  className="p-2 text-black bg-primary hover:bg-primary-dark rounded-lg"
                >
          ...
          <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          } rounded-md text-black focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all duration-200 focus:shadow-[0_0_15px_rgba(22,93,255,0.3)] disabled:opacity-60 disabled:cursor-not-allowed`}
                        />
                        {errors.username && (
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2  border border-gray-600 rounded-md text-black focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all duration-200 focus:shadow-[0_0_15px_rgba(22,93,255,0.3)] disabled:opacity-60 disabled:cursor-not-allowed"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleInputChange}
                          disabled={!editMode}
                          className="w-full px-3 py-2  border border-gray-600 rounded-md text-black focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed"
                        >
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      {/* Fitness Goal */}
                      <div>
                        <label htmlFor="fitness_goal" className="block text-sm font-medium text-black  mb-1">
                          Fitness Goal
                        </label>
                        <select
                          id="fitness_goal"
                      ...
                      {/* Fitness Level */}
                      <div>
                        <label htmlFor="fitness_level" className="block text-sm font-medium text-black  mb-1">
                          Fitness Level
                        </label>
                        <select
                          id="fitness_level"
                      ...
                      {/* Health Condition */}
                      <div>
                        <label htmlFor="health_condition" className="block text-sm font-medium text-black  mb-1">
                ...
                {editMode && (
                  <div className="flex justify-end pt-4 border-t border-gray-700">
                    <button
                      type="button"
                      onClick={() => setEditMode(false)}
                      className="px-4 py-2 bg-gray-700 text-black rounded-md hover:bg-gray-600 mr-3"
                    >
                      Cancel
                    </button>
                    <button
            ...
            {activeTab === 'membership' && (
              <div>
                {mockUser.membership_type ? (
                  <div>
                    <div className=" rounded-xl p-6 mb-6 border border-gray-600">
                      <h3 className="text-lg font-semibold text-black mb-4 flex items-center">
                      ...
                      <div className="space-y-4">
                        <div className="flex flex-wrap items-center">
                          <div className="mr-6 mb-2">
                            ...
                            <span className="text-lg font-medium text-black ">
                              {mockUser.membership_type === 'monthly' ? 'Monthly Plan' :
                               mockUser.membership_type === 'quarterly' ? 'Quarterly Plan' :
                               mockUser.membership_type === 'yearly' ? 'Yearly Plan' : 'Premium'}
                            </span>
                          </div>
                          ...
                          <div className="mr-6 mb-2">
                            ...
                            <span className="text-lg font-medium text-black ">
                              {mockUser.membership_start ? 
                                new Date(mockUser.membership_start).toLocaleDateString() : 
                                'N/A'}
                            </span>
                          </div>
                          ...
                          <div className="mb-2">
                            ...
                            <span className="text-lg font-medium text-black ">
                              {mockUser.membership_end ? 
                                new Date(mockUser.membership_end).toLocaleDateString() : 
                                'N/A'}
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="pt-4 border-t border-gray-600">
                          <div className="flex items-center">
                            ...
                            <span className="text-black ">Your membership is active</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="text-center">
                      <button 
                        ...
                        className="inline-flex items-center px-4 py-2 bg-primary hover:bg-primary-dark text-black rounded-md transition-colors duration-200"
                      >
                        Upgrade Membership
                  ...
                  <div className="text-center py-8">
                    <div className="mb-4 text-gray-400">
                      ...
                      <h3 className="text-lg font-medium text-black mb-2">No Active Membership</h3>
              ...
              <div>
                ...
                <div className="text-center py-8">
                  <div className="mb-4 text-gray-400">
                    ...
                    <h3 className="text-lg font-medium text-black mb-2">No Courses Enrolled</h3>
                    <p className="max-w-md mx-auto mb-6">
