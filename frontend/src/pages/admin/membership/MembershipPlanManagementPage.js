...
const MembershipPlanManagementPage = () => {
  ...
  // mock membership plan data (English)
  const mockPlans = [
    {
      id: 1,
      name: 'Basic Plan',
    ...
    },
    {
      ...
      duration: 365,
      price: 999,
      description: 'All benefits of Basic plus personal trainer sessions.',
      benefits: ['Gym access', 'Group classes', 'Personal trainer'],
      is_active: true,
    },
    {
      id: 3,
...
// fetch membership plans using mock data
  const fetchPlans = async () => {
    setLoading(true);
    setTimeout(() => {
      let filtered = mockPlans.filter(
          p =>
              !search ||
