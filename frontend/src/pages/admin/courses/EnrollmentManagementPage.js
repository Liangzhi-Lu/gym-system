...
// fetch functions use mock data
  const fetchEnrollments = async (page = 1, pageSize = 10) => {
    setLoading(true);
    setTimeout(() => {
      setEnrollments(mockEnrollments.slice((page - 1) * pageSize, page * pageSize));
      setPagination({
        current: page,
        pageSize: pageSize,
