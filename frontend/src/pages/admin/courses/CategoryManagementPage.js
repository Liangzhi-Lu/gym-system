...
const CategoryManagementPage = () => {
  ...
  //   setLoading(false);
  // };
// mock category data (English)
  const mockCategories = [
    {
      id: 1,
      name: 'Fitness',
      description: 'Courses related to fitness and health',
    },
    {
      id: 2,
      name: 'Yoga',
    ...
    },
    {
      id: 3,
      name: 'Dance',
      description: 'Dance courses including ballet, hip-hop, and more',
    },
  ];
  ...
  const fetchCategories = async () => {
    setLoading(true);
    setTimeout(() => {
      let filtered = mockCategories.filter(
          c =>
              !search ||
